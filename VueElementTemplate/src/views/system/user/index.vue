...
import { userRules, queryObjects } from "@/data/user";
...
const queryParams = reactive<UserQuery>({ pageNum: 1, pageSize: 10 });
...
//   ],
// });
const rules = reactive({ userRules });

/** 查询 */
function handleQuery(params: any) {
  queryParams.startTime = params?.createTime ? params.createTime[0] : undefined;
  queryParams.endTime = params?.createTime ? params.createTime[1] : undefined;
  loading.value = true;
