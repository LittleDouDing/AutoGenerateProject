...
// node_modules/.pnpm/@wangeditor+editor-for-vue@5.1.10_@wangeditor+editor@5.1.23_vue@3.4.21/node_modules/@wangeditor/editor-for-vue/dist/index.esm.js
...
var _sfc_main$1 = defineComponent({
  ...
  setup(props, context) {
    ...
    function setHtml(newHtml) {
      ...
      md.setNodes(editor, { type: "paragraph" }, { mode: "highest" });
      ...
      try {
        editor.select(JSON.parse(editorSelectionStr));
      } catch (ex) {
        editor.select(Bf.start(editor, []));
      }
    }
    onMounted(() => {
      initEditor();
